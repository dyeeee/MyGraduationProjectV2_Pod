...
struct TestCardRouterView: View {
    ...
    var body: some View {
        ZStack{
            ...
            TestCardView1(learningWordItem: learningWordItem, learnWordVM: self.learnWordVM,
                           wordVM: self.wordVM, todayReviewCount: self.$todayReviewCount)
        }else if learningWordItem.todayReviewCount == 1{
            TestCardView2(learningWordItem: learningWordItem, learnWordVM: self.learnWordVM,
                            wordVM: self.wordVM, todayReviewCount: self.$todayReviewCount)
        }}.onAppear(perform: {
...
struct TestCardRouterView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return
            VStack {
                ...
                ZStack {
                    TestCardRouterView(learningWordItem: learnWord, learnWordVM: LearnWordViewModel(), wordVM: WordViewModel(),afterUnknown: false, todayReviewCount: .constant(0))
