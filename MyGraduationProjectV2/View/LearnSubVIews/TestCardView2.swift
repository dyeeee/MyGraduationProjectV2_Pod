...
struct TestCardView2_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return
            VStack {
                ...
                ZStack {
                    TestCardView2(learningWordItem: learnWord, learnWordVM: LearnWordViewModel(), wordVM: WordViewModel(),afterUnknown: false, todayReviewCount: .constant(0))
                        //.frame(width: UIScreen.main.bounds.width - 20, alignment: .center)
                        .overlay(
